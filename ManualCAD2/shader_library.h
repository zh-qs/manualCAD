...
namespace ManualCAD
{
	...
	public:
		...
		GLint ul_color_location, utl_color_location, up_color_location, ub_color_location, upa_color_location, upb_color_location, upr_color_location, us_color_location, u2d_color_location, uw_color_location, ut_color_location, ubfr_color_location;
		...
		GLint ubfr_form_location;
		GLint ubfr_specular_exponent_location;
