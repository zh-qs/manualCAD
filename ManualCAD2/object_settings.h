...
namespace ManualCAD
{
	...
	public:
		...
		static void build_bicubic_c2_nurbs_surface_settings(BicubicC2NURBSSurface& surf, ObjectSettingsWindow& parent);
		...
		static void build_bicubic_c2_nurbs_surface_preview_settings(BicubicC2NURBSSurfacePreview& preview, ObjectSettingsWindow& parent);
		...
		static void build_ellipsoid_settings(Ellipsoid& ellipsoid, ObjectSettingsWindow& parent);
	};
}